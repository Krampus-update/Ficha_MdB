...
common.atributos = {
	...
	companionconstituicao	= 'Constituição do Companion',
	companioninteligencia	= 'Inteligência do Companion',
	companionsabedoria		= 'Sabedoria do Companion',
	companioncarisma		= 'Carisma do Companion',
	companionsanidade		= 'Sanidade do Companion',
	companionhonra			= 'Honra do Companion'
};
common.atributos2 = {
	forca					= {'FOR', 'STR'},
	destreza				= {'DES', 'DEX'},
	...
	companionforca			= {'CFOR', 'CSTR'},
	companiondestreza		= {'CDES', 'CDEX'},
	companionconstituicao	= {'CCON', 'CCON'},
	companioninteligencia	= {'CINT', 'CINT'},
	companionsabedoria		= {'CSAB', 'CWIS'},
	companioncarisma		= {'CCAR', 'CCHA'},
	companionsanidade		= {'CSAN', 'CSAN'},
	companionhonra			= {'CHON', 'CHON'}
};
common.pericias = {
	atletismo		= 'Atletismo',
	acrobacia		= 'Acrobacia',
	...
	periciaforca				= 'Não Listada',
	periciadestreza				= 'Não Listada',
	periciaconstituicao			= 'Não Listada',
	periciainteligencia			= 'Não Listada',
	periciasabedoria			= 'Não Listada',
	periciacarisma				= 'Não Listada',
	periciasanidade				= 'Não Listada',
	periciahonra				= 'Não Listada',

	companionatletismo			= 'Atletismo do Companion',
	companionacrobacia			= 'Acrobacia do Companion',
	companionfurtividade		= 'Furtividadedo Companion',
	companionprestidigitacao	= 'Prestidigitação do Companion',
	companionconcentracao		= 'Concentração do Companion',
	companiontolerancia			= 'Toleranciado Companion',
	companionarcanismo			= 'Arcanismodo Companion',
	companionhistoria			= 'História do Companion',
	companioninvestigacao		= 'Investigação do Companion',
	companionnatureza			= 'Natureza do Companion',
	companionreligiao			= 'Religião do Companion',
	companionadestrarAnimais	= 'Adestrar Animais do Companion',
	companionintuicao			= 'Intuição do Companion',
	companionmedicina			= 'Medicina do Companion',
	companionpercepcao			= 'Percepção do Companion',
	companionsobrevivencia		= 'Sobrevivência do Companion',
	companionatuacao			= 'Atuação do Companion',
	companionenganacao			= 'Enganação do Companion',
	companionintimidacao		= 'Intimidação do Companion',
	companionpersuasao			= 'Persuasão do Companion'
};
...
function common.rolaMagia2(node, modo, args, chat)
	...
	elseif args.estado == 'preparaTesteResistencia' then
		...
		args.testeResistencia = {
			atributo = common.atributos[args.magia.cdResistenciaAtributo],
