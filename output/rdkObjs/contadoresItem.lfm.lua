...
local function constructNew_frmContador()
    ...
    obj.editResetVal:setParent(obj.layout9);
    obj.editResetVal:setName("editResetVal");
    obj.editResetVal:setAlign("left");
    obj.editResetVal:setMargins({left=2});
    obj.editResetVal:setWidth(30);
    ...
    obj.dataLink7:setField("resetsDescanso Curto");
    obj.dataLink7:setDefaultValue("Não Muda");
    obj.dataLink7:setName("dataLink7");

    obj.dataLink8 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink8:setParent(obj.layout8);
    obj.dataLink8:setField("resetsDescanso Curto2");
    obj.dataLink8:setDefaultValue("");
    obj.dataLink8:setName("dataLink8");

    obj.dataLink9 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink9:setParent(obj.layout8);
    obj.dataLink9:setField("resetsDescanso Longo");
    obj.dataLink9:setDefaultValue("Não Muda");
    obj.dataLink9:setName("dataLink9");

    obj.dataLink10 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink10:setParent(obj.layout8);
    obj.dataLink10:setField("resetsDescanso Longo2");
    obj.dataLink10:setDefaultValue("");
    obj.dataLink10:setName("dataLink10");

    obj.dataLink11 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink11:setParent(obj.layout8);
    obj.dataLink11:setField("selectedResetTime");
    obj.dataLink11:setDefaultValue("Descanso Curto");
    obj.dataLink11:setName("dataLink11");

    obj.dataLink12 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink12:setParent(obj.layout8);
    obj.dataLink12:setField("selectedResetVal");
    obj.dataLink12:setDefaultValue("Não Muda");
    obj.dataLink12:setName("dataLink12");

    obj.dataLink13 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink13:setParent(obj.layout8);
    obj.dataLink13:setField("selectedResetVal2");
    ...
    obj._e_event7 = obj.dataLink11:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event8 = obj.dataLink12:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.selectedResetTime ~= nil then
    ...
    obj._e_event10 = obj.btnDelete:addEventListener("onClick",
        function (_)
            askForDelete();
        end, obj);

    obj._e_event11 = obj.btnDelete:addEventListener("onMenu",
        function (_, x, y)
