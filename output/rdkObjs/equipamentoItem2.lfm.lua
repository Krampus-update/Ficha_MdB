...
local function constructNew_frmEquipamentoItem2()
...
function newfrmEquipamentoItem2()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmEquipamentoItem2();
      end,
      function()
...
local _frmEquipamentoItem2 = {
    newEditor = newfrmEquipamentoItem2, 
    new = newfrmEquipamentoItem2, 
    name = "frmEquipamentoItem2", 
    dataType = "", 
    formType = "undefined", 
...
frmEquipamentoItem2 = _frmEquipamentoItem2;
Firecast.registrarForm(_frmEquipamentoItem2);

return _frmEquipamentoItem2;
