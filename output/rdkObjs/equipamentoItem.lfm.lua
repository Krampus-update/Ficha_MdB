...
local function constructNew_frmEquipamentoItem()
    ...
    obj.layMenu:setWidth(52);
    obj.layMenu:setMargins({top=10, left=1, bottom=10});

    obj.btnApagar = GUI.fromHandle(_obj_newObject("button"));
    obj.btnApagar:setParent(obj.layMenu);
    obj.btnApagar:setName("btnApagar");
    obj.btnApagar:setAlign("none");
    obj.btnApagar:setLeft(0);
    ...
    obj.btnRolarAtaque:setAlign("none");
    obj.btnRolarAtaque:setLeft(27);
    ...
    obj.edtGridCampoSolido2:setReadOnly(false);
    ...
    obj.edtGridCampoSolido3:setReadOnly(false);
    ...
    obj.edtGridCampoSolido6:setReadOnly(false);
    ...
    obj.edtGridCampoSolido8:setReadOnly(false);
    ...
    obj._e_event3 = obj.btnRolarAtaque:addEventListener("onMenu",
        function (_, x, y)
            rolarAtaque(2, true);
        end, obj);

    obj._e_event4 = obj.fraLayout:addEventListener("onResize",
        function (_)
