...
self.upperGridMagicBox3._RecalcSize();	
 ...
 require("descanso.lua"); 
    ...
    obj.label133:setParent(obj.layout127);
    obj.label133:setLeft(0);
    obj.label133:setTop(560);
    obj.label133:setWidth(500);
    obj.label133:setHeight(20);
    obj.label133:setText("ANOTAÇÕES DO MESTRE");
    ...
    obj.label134:setParent(obj.layout128);
    obj.label134:setLeft(50);
    obj.label134:setTop(30);
    obj.label134:setWidth(200);
    obj.label134:setHeight(20);
    obj.label134:setText("CONHEÇA A MESA:");
